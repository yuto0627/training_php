$(function () {
    ...
    $(document).on('click', '.delete-icon', function () {
        ...
        confirm('No.' + id + 'のユーザーを削除してよろしいですか？')
        ...
        $.ajax({
            ...
            .done(function (data) {
                $.each(data, function (key, value) {
                    ...
                    $('#user_data').append('<tr><td>' + '<input type="checkbox"></td><td>' + value.seq_no + '</td><td>' + value.user_id +
                        '</td><td id=' + value.seq_no + ' class="edit-icon"><i class="fa-solid fa-pen-to-square"></i></td><td id=' + value.seq_no + ' class="delete-icon"><i class="fa-solid fa-xmark"></i></td></tr>');
                });
            }).fail(function (data) {
                alert('通信失敗');
            })
